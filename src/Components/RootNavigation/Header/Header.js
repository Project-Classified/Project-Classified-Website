      ...
      <div className="HeaderBody">
        ...
        <div className="NavBar">
          <div className="ButtonHolder" >
            ...
            <Link style={{ textDecoration: "none", color: "#444" }} className="Link" to="/Login"><Button><h4 style={{ padding: 0, margin: 0, color: props.isInHomePage ? "#fff" : "#444", textShadow: props.isInHomePage ? "0px 0px 5px rgba(0,0,0,1)" : "none" }}>Login</h4></Button></Link>
            <Link style={{ textDecoration: "none", color: "#444" }} className="Link" to="/Signup"><Button><h4 style={{ padding: 0, margin: 0, color: props.isInHomePage ? "#fff" : "#444", textShadow: props.isInHomePage ? "0px 0px 5px rgba(0,0,0,1)" : "none" }}>Register</h4></Button></Link>

            <Link style={{ textDecoration: "none", color: "#444" }} className="Link" to="/Login"><Button><h4 style={{ padding: 0, margin: 0, color: props.isInHomePage ? "#fff" : "#444", textShadow: props.isInHomePage ? "0px 0px 5px rgba(0,0,0,1)" : "none" }}>Post an Ad</h4></Button></Link>
